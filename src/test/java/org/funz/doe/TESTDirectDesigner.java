 ...
 *
 */
public class TESTDirectDesigner extends Designer {

    final static String QUICKHELP = "Basic direct designer";

    public TESTDirectDesigner() {
    _opts.put("N", "5");
    }
