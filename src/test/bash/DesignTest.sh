...
function testDesignParseError {
    ...
    if (($ok > 0)); then rm testDesignParseError.out; echo "OK";return 0; else echo "FAILED:"; cat testDesignParseError.out;return 1; fi
}
...
function testDesign {
    ...
    if (($ok > 0)); then rm testDesign.out; echo "OK";return 0; else echo "FAILED:"; cat testDesign.out;return 1; fi
}
...
function testDesignPar {
    ...
    if (($ok > 0)); then rm testDesignPar.out; echo "OK";return 0; else echo "FAILED:"; cat testDesignPar.out;return 1; fi
}
