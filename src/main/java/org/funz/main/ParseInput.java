 ...
 * @author richet
 */
public class ParseInput extends MainUtils{

    static String name = "ParseInput";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            vars = Utils.findVariables(_model, _input);
        ...
        if (_print.getName().endsWith(".xml")) {
            ASCII.saveFile(_print, MapToXMLString(vars, true));
        } else if (_print.getName().endsWith(".json")) {
            ASCII.saveFile(_print, MapToJSONString(vars));
        } else {
            ASCII.saveFile(_print, MapToCSVString(vars));
        }
